...
@include('carousel')
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-6 mx-auto mt-2 p-3">
            <div>
                <img width="100%" src="{{asset("services/".$services[app()->getLocale()][$data]["image"])}}" alt="service image" />
            </div>
            <h2 class="py-4">{{ $services[app()->getLocale()][$data]["titre"]}}</h2>
            <p>
               {{ $services[app()->getLocale()][$data]["contenu"] }}
            </p>
        </div>
