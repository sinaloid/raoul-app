            ...
            <div class="d-flex">
                <div class="mll-3 p-0">
                    <a class="navbar-brand py-0" href="{{ route('accueil') }}">
                        <img style="width: 160px !important;" src="{{ asset('assets/img/logo.jpg') }}"
                            alt="logo recis" />
                    </a>
                </div>
                <div class="d-flex align-items-center justify-content-end w-100">
                    <div class="d-inline-block me-auto px-1 font-weight-bold text-white sm-title-3 text-right"
                        style="height: fit-content">
                        <span class="d-block text-uppercase sm-title-1">AGTL</span>
                        <div class="d-block mb-1 text-uppercase">

                            <a class="text-white" href="tel:+22671302973">
                                <span>
                                    <img width="20px" src="{{ asset('assets/img/phone.png') }}" alt="">
                                </span>
                                <span class="d-md-none">BF</span> <span class="d-none d-md-inline">

                                    +226 71 30 29 73</span>
                            </a>
                            /
                            <a class="text-white" href="tel:+18324065684">
                                <span>
                                    <img width="20px" src="{{ asset('assets/img/phone.png') }}" alt="">
                                </span>
                                <span class="d-md-none">CA</span> <span class="d-none d-md-inline">

                                    +1 (832) 406-5684</span>
                            </a>
                        </div>
                        <div class="d-block mb-1 text-uppercase">
                            <a class="text-white" href="//api.whatsapp.com/send?phone=22671302973&text=infos">
                                ...
                                </svg> <span class="d-md-none">BF</span> <span class="d-none d-md-inline">

                                    +226 71 30 29 73</span></a>

                            /
                            <a class="text-white" href="//api.whatsapp.com/send?phone=18324065684&text=infos">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 39 39">
                                    <path fill="#00E676"
                                        d="M10.7 32.8l.6.3c2.5 1.5 5.3 2.2 8.1 2.2 8.8 0 16-7.2 16-16 0-4.2-1.7-8.3-4.7-11.3s-7-4.7-11.3-4.7c-8.8 0-16 7.2-15.9 16.1 0 3 .9 5.9 2.4 8.4l.4.6-1.6 5.9 6-1.5z">
                                ...
                                </svg> <span class="d-md-none">CA</span> <span class="d-none d-md-inline">
                                    <span class="d-none d-md-inline">+1 (832)
                                        406-5684</span>
                            </a>
                        </div>
                        <span class="d-block text-uppercase mb-1">
                            
                            <a class="text-white d-inline" href="mailto:aguila.trading.logistics@agtlcargo.com">
                            <span><i class="fa fa-envelope fa-xl"></i></span> :
                            <span class="d-none d-md-inline">aguila.trading.logistics@agtlcargo.com</span> 
