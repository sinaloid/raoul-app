        <footer class="row pt-3 mt-5 bg-dark text-white">
            <div class="col-12 col-md-10 mx-auto d-flex flex-wrap">
                <div class="col-12 col-sm-6 pb-3">
                    <div class="mx-md-auto" style="width: fit-content">
                        <div class="d-inline-block font-weight-bold text-white sm-title-3"
                            ...
                            <span class="d-block mb-1 text-uppercase">
                                ...
                                : <a class="text-white" href="tel:+22671302973">+226 71 30 29 73</a> / <a class="text-white" href="tel:+18324065684">+1 (832) 406-5684</a></span>
                                ...
                                <a class="text-white" href="//api.whatsapp.com/send?phone=22671302973&text=infos">+226 71 30 29 73</a>
    
                                /
                                <a class="text-white" href="//api.whatsapp.com/send?phone=18324065684&text=infos">+1 (832) 406-5684</a>
                            </span>
                            <span class="d-block text-uppercase mb-1">
                                <span><i class="fa fa-envelope fa-xl"></i></span> :
                                <a class="text-white" href="mailto:aguila.trading.logistics@agtlcargo.com">aguila.trading.logistics@agtlcargo.com</a></span>
                ...
                <div class="col-12 col-sm-3 pb-3">
                    <div class="mx-md-auto text-center1" style="width: fit-content">
                        <span
